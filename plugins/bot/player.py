...
async def yplay(_, message: Message):
    if ADMIN_ONLY == "True":
        ...
        if message.from_user.id not in admins:
            m=await message.reply_sticker("CAACAgQAAx0CVUFv6wABD07WYXgQ7lXw_kxwu1ce0o0Wg6av7pQAAo4JAAKll3FRi8cbJwhnua0hBA")
            await mp.delete(m)
...
async def notforu(_, m: Message):
    k=await m.reply_sticker("CAACAgQAAx0CVUFv6wABD07WYXgQ7lXw_kxwu1ce0o0Wg6av7pQAAo4JAAKll3FRi8cbJwhnua0hBA")
    await mp.delete(k)
    await mp.delete(m)
