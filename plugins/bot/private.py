...
HOME_TEXT = "👋🏻 **Hi [{}](tg://user?id={})**,\n\nI'm **Raksha** \nI Can Play Radio / Music / YouTube Live In Channel & Group 24x7 Nonstop. Made with ❤️ By @Girl_Is_Innocent 😉!"
HELP_TEXT = """
💡 --**Setting Up**--:
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.lower() == "replay":
        ...
        buttons = [
            ...
            [
                InlineKeyboardButton("CHTTING", url="https://t.me/SPARKLES_WORLD"),
                InlineKeyboardButton("SUPPORT", url="https://t.me/SPARKLES_WORLD"),
            ],
            [
                InlineKeyboardButton("OWNER", url="https://t.me/Girl_Is_Innocent"),
                InlineKeyboardButton("SOURCE CODE", url="https://telegra.ph/file/61d9067b494338a4cf49a.jpg"),
            ],
            [
        ...
        buttons = [
            ...
            [
                InlineKeyboardButton("CHANNEL", url="https://t.me/SPARKLES_WORLD"),
                InlineKeyboardButton("SUPPORT", url="https://t.me/SPARKLES_WORLD"),
            ],
            [
                InlineKeyboardButton("OWNER", url="https://t.me/Girl_Is_Innocent"),
...
async def start(client, message):
    ...
    reply_markup = InlineKeyboardMarkup(buttons)
    m=await message.reply_photo(photo="https://telegra.ph/file/2e690c06ac0df63b1eaee.jpg", caption=HOME_TEXT.format(message.from_user.first_name, message.from_user.id), reply_markup=reply_markup)
    await mp.delete(m)
...
async def help(client, message):
    ...
    msg['help'] = await message.reply_photo(photo="https://telegra.ph/file/61d9067b494338a4cf49a.jpg", caption=HELP_TEXT, reply_markup=reply_markup)
    await mp.delete(message)
